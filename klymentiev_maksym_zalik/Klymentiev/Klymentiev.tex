...
Рисунки можна розміщувати в одну колонку (рис.~\ref{subfig1}, \ref{subfig2}), а додавши зірочку <<*>> до оточення \texttt{figure*}, можна їх
розташувати так, щоб вони займали дві колонки (рис.~\ref{subfig3}, \ref{subfig4}).
...
\begin{figure}[t!]
	...
	\subcaptionbox{Перший рисунок\label{subfig1}.}{%
		\includegraphics[width=0.95\columnwidth]{LionTeX}
	}%
	\\[2ex] % <- для того, щоб рисунки розташувались в колонку
	\subcaptionbox{Другий рисунок\label{subfig2}.}{
		\includegraphics[width=0.95\columnwidth]{LionTeX}
	}%
	\figcaption{Рисунки \protect\subref{subfig3} та \protect\subref{subfig4} розташовані один над одним.}
	\label{Logoipt1}
\end{figure}
...
\begin{figure*}[h!]
	...
	\figcaption{Рисунки \protect\subref{subfig3} та \protect\subref{subfig4} розташовані поряд.}
	\label{Logoipt2}
\end{figure*}
